...
TEST(LogLevel, EnumValuesAreOrdered) {
    static_assert(static_cast<uint8_t>(LogLevel::Trace) < static_cast<uint8_t>(LogLevel::Debug));
    static_assert(static_cast<uint8_t>(LogLevel::Debug) < static_cast<uint8_t>(LogLevel::Info));
    static_assert(static_cast<uint8_t>(LogLevel::Info)  < static_cast<uint8_t>(LogLevel::Warn));
    static_assert(static_cast<uint8_t>(LogLevel::Warn)  < static_cast<uint8_t>(LogLevel::Error));
    static_assert(static_cast<uint8_t>(LogLevel::Error) < static_cast<uint8_t>(LogLevel::Fatal));
    static_assert(static_cast<uint8_t>(LogLevel::Fatal) < static_cast<uint8_t>(LogLevel::Off));
